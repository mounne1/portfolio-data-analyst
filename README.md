...
**Outils :** SQL Server · Power BI (Power Query, DAX, RLS) · Tableau · Excel · Python

---

## Stop Churn 360 — Analyse des résiliations en assurance auto

![Tableau de bord Stop Churn 360](stop-churn-360/dashboard.png)
...
📄 [Rapport complet (PDF)](stop-churn-360/Stop_Churn_360_Rapport.pdf)
...
et qu'est-ce qui explique les écarts ?
...
- Rapport en trois pages : vue séjours, vue client par pays, synthèse

### Vue séjours

![Vue séjours](club-med/vue-sejours.png)

### Vue client par marché

![Vue client](club-med/vue-client.png)

### Les résultats

![Synthèse](club-med/synthese.png)
...
La Belgique affiche à l'inverse la plus faible rentabilité et les séjours les
plus courts, malgré un volume supérieur au Canada.
...
[Profil Tableau Public](https://public.tableau.com/app/profile/mouniratou.ouedraogo2957) —
exercices d'apprentissage sur Tableau, à partir du jeu de données Superstore.
...
📧 mounne1@gmail.com
💼 [LinkedIn](https://www.linkedin.com/in/mouniratou-ouedraogo-2107a3199/)
📍 Bruxelles
